...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        T_0A_x_error, T_0A_y_error, T_0A_z_error, T_0A_roll_error, T_0A_pitch_error, T_0A_yaw_error = utilities.find_errors_between_2_poses(T_0A_pos_est, np.array(T_0A_quat_est), T_0A_pos_ref, np.array(T_0A_quat_ref))
        ...
        controller_x_error, controller_y_error, controller_z_error, controller_roll_error, controller_pitch_error, controller_yaw_error = utilities.find_errors_between_2_poses(achieved_T_0A_pos_est, np.array(achieved_T_0A_quat_est), T_0A_pos_est, np.array(T_0A_quat_est))
